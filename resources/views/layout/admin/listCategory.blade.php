                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="">
                                        ...
                                        <td style="text-align: center;">
                                            <a href="{{url('layout/admin/editCategory/'.$category->id)}}">
                                        ...
                                        <td style="text-align: center;">
                                            <a href="{{url('layout/admin/deleteCategory/'.$category->id)}}">
                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="">
                                        ...
                                        <td>{{$country->name}}</td>
                                        <td style="text-align: center;">
                                            <a href="{{url('layout/admin/editCountry/'.$country->id)}}">
                                                <span class="badge bg-primary">
                                                    <ion-icon name="create-outline"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                    </ion-icon>
                                                </span>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="{{url('layout/admin/deleteCountry/'.$country->id)}}">
                                                <span class="badge bg-danger">
                                                    <ion-icon name="trash-outline"><i class="fa fa-minus-circle" aria-hidden="true"></i>
                                                    </ion-icon>
                                                </span>
